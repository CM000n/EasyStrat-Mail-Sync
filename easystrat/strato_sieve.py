...
class SieveScriptBuilder:
    ...
    def build_redirect_script(emails: Set[str], keep_local: bool = True) -> str:
        ...
        Args:
            ...
            keep_local: Wenn True, wird eine Kopie local behalten (:copy)

        Returns:
            Sieve-Script also String
        """
        lines = [
            "# EasyVerein-Strato Mail Sync",
            "# Automatisch generiertes Weiterleitungs-Script",
            "# NICHT MANUAL BEARBEITEN!",
            "#",
    ...
    def connect(self) -> bool:
        ...
        try:
            ...
            if not self._client.connect(
                self.config.email, self.config.password, starttls=True, authmech="PLAIN"
            ):
