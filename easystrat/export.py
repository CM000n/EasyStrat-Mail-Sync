...
class EmailExporter:
    """
    Exportiert E-Mail-Adressen aus EasyVerein in verschiedene Format.
    """
    ...
    def export_emails_txt(self, output_path: Optional[Path] = None) -> Path:
        ...
        with open(output_path, "w", encoding="utf-8") as f:
            ...
            f.write("#\n")
            f.write(
                "# Diese E-Mail-Adressen sollten in Strato also Weiterleitung eingetragen sein:\n"
            )
            f.write("#\n\n")
    ...
    def export_members_csv(self, output_path: Optional[Path] = None) -> Path:
        ...
        with open(output_path, "w", encoding="utf-8", newline="") as f:
            ...
            for m in sorted(members, key=lambda x: x.email):
                writer.writerow(
                    [m.membership_number or "", m.first_name or "", m.last_name or "", m.email]
                )
